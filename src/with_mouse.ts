...
// USING RAYCASTER WITH A MOSE

// we need to get position of the cursor
// we will first do a hoveering part where we want to know if
// our cursor is above one of the spheres
// we are difining mousemove handler

// in tick function we are going to use
// raycaster.setFromCamra
// where we are going to add Vector2, that will represent mouse position
// and we will add camera
