...
// RAYCASTER WITH MOSEENTER AND MOUSELEAVE

// WE DON'T HAVE ACCES TO THESE EVENTS

// BUT WE CAN "RECREATE" THEM WITH THIS KINF=D OF SOLUUTION

// solution

// - create "witness" variable (currentIntersect) containing current hovered object
...
// we wil ldefine this varible just before tick, and everything else we
// are going to define innside tick
